...
class DETECTION_TRANSFORMER(nn.Module):
    def __init__(self, cfg, backbone):
        ...
        # add semantic
        self.text_class = MLP(self.d_model, self.d_model, self.voc_size + 1, 3)
        ...
        # add semantic init
        nn.init.constant_(self.text_class.layers[-1].weight.data, 0)
        nn.init.constant_(self.text_class.layers[-1].bias.data, 0)
        self.transformer.text_class_embed = self.text_class
